    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            @if (session()->has('success'))
                <div class="m-4 shadow appearance-none border rounded w-600 h-9 text-left py-2 px-3 text-gray-700
                            leading-tight focus:outline-none focus:shadow-outline bg-red-200" role="alert">
                    <p>{{ session('success') }}</p>
                </div>
            @endif
